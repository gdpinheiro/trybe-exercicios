...
let imgEx7 = document.createElement("img");

document.getElementsByClassName("left-content")[0].appendChild(imgEx7);

imgEx7.setAttribute("src", "https://picsum.photos/200");

imgEx7.className = "small-image";
...
let deletion = document.querySelector(".left-content");

document.querySelector(".main-content").removeChild(deletion);

// 4. Centralize a section criado no passo 6 (aquele que possui a classe right-content ). Dica: para centralizar, basta configurar o margin-right: auto da section ;

document
  .querySelector(".right-content")
  .setAttribute("style", "margin-right: auto");

// toCenter.setAttribute("", "")
